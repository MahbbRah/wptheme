  ...
  $custom_settings = array( 
    ...
    'sections'        => array( 
      ...
      array(
        ...
        'title'       => __( 'Blog Header Settings', 'theme-text-domain' )
      ),
      array(
        'id'          => 'Blog_footer_settings',
        'title'       => __( 'Blog Footer Settings', 'theme-text-domain' )
      ),
    ),
    'settings'        => array( 
     array(
        ...
        'desc' => 'Enter your phone number to show on top left bar on your website',
        'type' => 'text',
     ...
     array(
        'id' => 'header_logo',
        'label' => 'Header Logo',
        'desc' => 'Upload your Header Logo for best view image size (40*41)',
        'type' => 'upload',
        'section' => 'header_settings',
        ), 
     array(
        'id' => 'copyrigth_texts',
        'label' => 'Footer copyright texts',
        'desc' => 'Enter your Footer copyright Texts',
        'type' => 'list-item',
        ...
        'settings' => array(
              array(
                  ...
                  'desc' => 'Enter your link there you want share link',
                  '' => '',
              ...
              array(
                  ...
                  'id' => 'text_of_url',
                  'type' => 'text',
                  'label' => 'Footer text there you want url',
                  'desc' => 'Enter your text there you want to share link',
                  '' => '',
              ...
              array(
                  ...
                  'type' => 'text',
                  'label' => 'Normal Texts',
                  'desc' => 'Text that dont contain any url ',
     ...
     array(
        ...
        'desc' => 'Enter your Email address to show on top left bar on your website',
        'type' => 'text',
        'section' => 'header_settings',
        
        ), 
     array(
        'id' => 'header_socialButton',
        'label' => 'Header Social button',
        'desc' => 'Enter your social link address.',
        'type' => 'list-item',
        'section' => 'header_settings',
        'settings' => array(
            array(
                 ...
                 'label' => ' Icon Name',
                 'type' => 'text',
                 'desc' => 'We used Fontawesome for icon. So, if you want to insert icon then start after fa fa- ',
                 'std' => 'fa fa-',
            ...
            array(
                 ...
                 'label' => ' Icon link',
                 'type' => 'text',
                 'desc' => 'Enter your social network site url',
                 '' => '',
            ...
            array(
                 ...
                 'type' => 'text',
                 'desc' => 'Enter your Hover title of icon',
     ...
     array(
        'id' => 'footer_socialButton',
        'label' => 'Footer Social button',
        'desc' => 'Enter your social link address.',
        'type' => 'list-item',
        'section' => 'footer_settings',
        'settings' => array(
            ...
            array(
                 ...
                 'label' => ' Icon Title',
                 'type' => 'text',
                 'desc' => 'Enter title that you want to view on hover. ',
     ...
     array(
        'id' => 'blog_skype_id',
        'label' => 'Header Skype ID',
        'desc' => 'Enter your Skype ID to show on top left bar on your website',
        'type' => 'text',
        'section' => 'Blog_header_settings',
        
        ), 
     array(
        'id' => 'blog_header_socialButton',
        'label' => 'Blog Header Social button',
        'desc' => 'Enter your social link address.',
        'type' => 'list-item',
        'section' => 'Blog_header_settings',
        'settings' => array(
     ...
     array(
        'id' => 'Blog_header_logo',
        'label' => 'Blog Header Logo',
        'desc' => 'Upload your Header Logo for best view image size (40*41)',
        'type' => 'upload',
        'section' => 'Blog_header_settings',
        ), 
     array(
        'id' => 'blog_copyrigth_texts',
        'label' => 'Blog Footer copyright texts',
        'desc' => 'Enter your Blog Footer copyright Texts',
        'type' => 'list-item',
        'section' => 'Blog_footer_settings',
        'settings' => array(
              array(
                  
                  'id' => 'blog_footer_text_url',
                  'type' => 'text',
                  'label' => 'Blog Footer text link',
                  'desc' => 'Enter your link there you want share link',
                  'std' => 'http://www.',
              ...
              array(
                  ...
                  'id' => 'blog_text_of_url',
                  'type' => 'text',
                  'label' => 'Blog Footer text there you want url',
                  'desc' => 'Enter your text there you want to share link',
                  '' => '',
